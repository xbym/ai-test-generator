...
const quizData = {"title":"MBTI人格测试小测验","description":"本测试包含5个多选题，旨在帮助你更好地理解MBTI人格类型理论。请根据你的直觉选择最符合你性格的选项。","questions":[{"question":"在社交场合中，你通常更倾向于：","options":["与少数几个亲密的朋友深入交流","与一大群人轻松互动","观察他人并分析他们的行为","寻找机会展示自己的才华"],"correctAnswer":0},{"question":"当你面对一个新任务时，你更可能：","options":["立即开始行动，边做边想","先制定详细的计划，再开始执行","寻求他人的意见和建议","想象完成任务后的成就感"],"correctAnswer":1},{"question":"在团队合作中，你通常扮演的角色是：","options":["领导者，负责决策和指导","协调者，确保团队成员和谐相处","创意者，提出新颖的想法和解决方案","执行者，负责具体任务的完成"],"correctAnswer":3},{"question":"当你遇到问题时，你更倾向于：","options":["依靠直觉和情感来解决问题","通过逻辑和分析来找到解决方案","寻求他人的帮助和建议","从过去的经验中寻找答案"],"correctAnswer":1},{"question":"在日常生活中，你更喜欢：","options":["有规律和结构化的生活方式","灵活多变，适应不同的情况","与他人保持紧密的联系","追求个人兴趣和爱好"],"correctAnswer":0}]};
